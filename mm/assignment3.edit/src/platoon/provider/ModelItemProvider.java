...
/**
 * This is the item provider adapter for a {@link platoon.Model} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PlatoonPackage.Literals.MODEL__CONSTRAINTS);
			childrenFeatures.add(PlatoonPackage.Literals.MODEL__PLATOONS);
			childrenFeatures.add(PlatoonPackage.Literals.MODEL__ROUTES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PlatoonPackage.Literals.MODEL__CONSTRAINTS,
				 PlatoonFactory.eINSTANCE.createConstraints()));

		newChildDescriptors.add
			(createChildParameter
				(PlatoonPackage.Literals.MODEL__PLATOONS,
				 PlatoonFactory.eINSTANCE.createPlatoon()));

		newChildDescriptors.add
			(createChildParameter
				(PlatoonPackage.Literals.MODEL__ROUTES,
