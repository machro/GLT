...
public class PlatoonItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PlatoonPackage.Literals.PLATOON__FIRST);
		}
		...
		newChildDescriptors.add
			(createChildParameter
				(PlatoonPackage.Literals.PLATOON__FOLLOWERS,
				 PlatoonFactory.eINSTANCE.createFV()));

		newChildDescriptors.add
			(createChildParameter
				(PlatoonPackage.Literals.PLATOON__FIRST,
				 PlatoonFactory.eINSTANCE.createLV()));
	}
